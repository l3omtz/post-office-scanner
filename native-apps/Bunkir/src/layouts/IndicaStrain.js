...
class IndicaStrain extends Component {
    ...
    componentWillMount(){
        firebase.database().ref('strains/indica')
  ...
  render() {
    ...
    return (
        <View style={{ backgroundColor: 'rgba(76, 175, 80, 0.2)'}}>
            <MainHeader navigate={this.props.navigation} title={'INDICA'} back={true} ptop={70}/>
