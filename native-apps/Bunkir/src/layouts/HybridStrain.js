...
class HybridStrain extends Component {
    ...
    componentWillMount(){
        firebase.database().ref('strains/hybrid')
  ...
  render() {
    ...
    return (
        <View style={{ backgroundColor: 'rgba(76, 175, 80, 0.2)'}}>
            <MainHeader navigate={this.props.navigation} title={'HYBRID'} back={true} ptop={70}/>
